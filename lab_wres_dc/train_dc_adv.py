...
parser.add_argument('--save-dir', type=str, default='log_wres')
parser.add_argument('--nmb_cluster', '--k', type=int, default=80,
...
log_filename = 'wres50_dc_apt_adv_k{}.txt'.format(args.nmb_cluster)
...
def train(loader, model, crit, opt, epoch):
    ...
    filename = '../cp_wres50/wres50_dc_apt_adv_k{}.pth'.format(args.nmb_cluster)
...
for epoch in range(1, args.epochs + 1):
    if epoch in [args.epochs * 0.4, args.epochs * 0.7, args.epochs * 0.9]:
        for param_group in optimizer.param_groups:
            param_group['lr'] *= 0.1
        print("Learning rate reduced.")
        k = int(k / 2)
        print(f'Clustering number = {k}.')
